...
export class EmpatiaComponent implements OnInit {
    ...
    this._preguntasService.listarPreguntas().subscribe(
      res => {
        ...
        for(var i=0; i<res.preguntas.length; i++){
          if(res.preguntas[i]["id_dimension"] == 4){
  ...
  realizarGraficas(){
    var dimension = "Empatía";
    this._preguntasService.listarRespuestaPreguntas().subscribe(
      res => {
        Object.assign(this, { muy_desacuerdo: [{name: res.respuesta[dimension][13]["pregunta"].slice(3), value: res.respuesta[dimension][13]["resultados"]["Muy en Desacuerdo"]}, {name: res.respuesta[dimension][14]["pregunta"].slice(3), value: res.respuesta[dimension][14]["resultados"]["Muy en Desacuerdo"]}, {name: res.respuesta[dimension][15]["pregunta"].slice(3), value: res.respuesta[dimension][15]["resultados"]["Muy en Desacuerdo"]}, {name: res.respuesta[dimension][16]["pregunta"].slice(3), value: res.respuesta[dimension][16]["resultados"]["Muy en Desacuerdo"]}] });
        Object.assign(this, { en_desacuerdo: [{name: res.respuesta[dimension][13]["pregunta"].slice(3), value: res.respuesta[dimension][13]["resultados"]["En Desacuerdo"]}, {name: res.respuesta[dimension][14]["pregunta"].slice(3), value: res.respuesta[dimension][14]["resultados"]["En Desacuerdo"]}, {name: res.respuesta[dimension][15]["pregunta"].slice(3), value: res.respuesta[dimension][15]["resultados"]["En Desacuerdo"]}, {name: res.respuesta[dimension][16]["pregunta"].slice(3), value: res.respuesta[dimension][16]["resultados"]["En Desacuerdo"]}] });
        Object.assign(this, { neutral: [{name: res.respuesta[dimension][13]["pregunta"].slice(3), value: res.respuesta[dimension][13]["resultados"]["Neutral"]}, {name: res.respuesta[dimension][14]["pregunta"].slice(3), value: res.respuesta[dimension][14]["resultados"]["Neutral"]}, {name: res.respuesta[dimension][15]["pregunta"].slice(3), value: res.respuesta[dimension][15]["resultados"]["Neutral"]}, {name: res.respuesta[dimension][16]["pregunta"].slice(3), value: res.respuesta[dimension][16]["resultados"]["Neutral"]}] });
        Object.assign(this, { de_acuerdo: [{name: res.respuesta[dimension][13]["pregunta"].slice(3), value: res.respuesta[dimension][13]["resultados"]["De Acuerdo"]}, {name: res.respuesta[dimension][14]["pregunta"].slice(3), value: res.respuesta[dimension][14]["resultados"]["De Acuerdo"]}, {name: res.respuesta[dimension][15]["pregunta"].slice(3), value: res.respuesta[dimension][15]["resultados"]["De Acuerdo"]}, {name: res.respuesta[dimension][16]["pregunta"].slice(3), value: res.respuesta[dimension][16]["resultados"]["De Acuerdo"]}] });
        Object.assign(this, { muy_acuerdo: [{name: res.respuesta[dimension][13]["pregunta"].slice(3), value: res.respuesta[dimension][13]["resultados"]["Muy de Acuerdo"]}, {name: res.respuesta[dimension][14]["pregunta"].slice(3), value: res.respuesta[dimension][14]["resultados"]["Muy de Acuerdo"]}, {name: res.respuesta[dimension][15]["pregunta"].slice(3), value: res.respuesta[dimension][15]["resultados"]["Muy de Acuerdo"]}, {name: res.respuesta[dimension][16]["pregunta"].slice(3), value: res.respuesta[dimension][16]["resultados"]["Muy de Acuerdo"]}] });
      }
    );
  }
  ...
  modalPregunta(numero, descripcion){
    ...
    this._preguntasService.listarRespuestaPreguntas().subscribe(
      res => {
        Object.assign(this, { pregunta: [{name: "Muy en desacuerdo", value: res.respuesta[dimension][numero+12]["resultados"]["Muy en Desacuerdo"]}, {name: "En desacuerdo", value: res.respuesta[dimension][numero+12]["resultados"]["En Desacuerdo"]}, {name: "Neutral", value: res.respuesta[dimension][numero+12]["resultados"]["Neutral"]}, {name: "De acuerdo", value: res.respuesta[dimension][numero+12]["resultados"]["De Acuerdo"]}, {name: "Muy de acuerdo", value: res.respuesta[dimension][numero+12]["resultados"]["Muy de Acuerdo"]}] });
      }
    );
  }
  ...
  verGrafica(nivel){
    this.estado = false;
    var id_pregunta = (this.numero_pregunta+12);
