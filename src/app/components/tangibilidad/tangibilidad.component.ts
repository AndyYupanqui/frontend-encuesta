...
export class TangibilidadComponent implements OnInit {
    ...
    this._preguntasService.listarPreguntas().subscribe(
      res => {
        ...
        for(var i=0; i<res.preguntas.length; i++){
          if(res.preguntas[i]["id_dimension"] == 5){
  ...
  realizarGraficas(){
    var dimension = "Tangibilidad";
    this._preguntasService.listarRespuestaPreguntas().subscribe(
      res => {
        Object.assign(this, { muy_desacuerdo: [{name: res.respuesta[dimension][17]["pregunta"].slice(3), value: res.respuesta[dimension][17]["resultados"]["Muy en Desacuerdo"]}, {name: res.respuesta[dimension][18]["pregunta"].slice(3), value: res.respuesta[dimension][18]["resultados"]["Muy en Desacuerdo"]}, {name: res.respuesta[dimension][19]["pregunta"].slice(3), value: res.respuesta[dimension][19]["resultados"]["Muy en Desacuerdo"]}, {name: res.respuesta[dimension][20]["pregunta"].slice(3), value: res.respuesta[dimension][20]["resultados"]["Muy en Desacuerdo"]}] });
        Object.assign(this, { en_desacuerdo: [{name: res.respuesta[dimension][17]["pregunta"].slice(3), value: res.respuesta[dimension][17]["resultados"]["En Desacuerdo"]}, {name: res.respuesta[dimension][18]["pregunta"].slice(3), value: res.respuesta[dimension][18]["resultados"]["En Desacuerdo"]}, {name: res.respuesta[dimension][19]["pregunta"].slice(3), value: res.respuesta[dimension][19]["resultados"]["En Desacuerdo"]}, {name: res.respuesta[dimension][20]["pregunta"].slice(3), value: res.respuesta[dimension][20]["resultados"]["En Desacuerdo"]}] });
        Object.assign(this, { neutral: [{name: res.respuesta[dimension][17]["pregunta"].slice(3), value: res.respuesta[dimension][17]["resultados"]["Neutral"]}, {name: res.respuesta[dimension][18]["pregunta"].slice(3), value: res.respuesta[dimension][18]["resultados"]["Neutral"]}, {name: res.respuesta[dimension][19]["pregunta"].slice(3), value: res.respuesta[dimension][19]["resultados"]["Neutral"]}, {name: res.respuesta[dimension][20]["pregunta"].slice(3), value: res.respuesta[dimension][20]["resultados"]["Neutral"]}] });
        Object.assign(this, { de_acuerdo: [{name: res.respuesta[dimension][17]["pregunta"].slice(3), value: res.respuesta[dimension][17]["resultados"]["De Acuerdo"]}, {name: res.respuesta[dimension][18]["pregunta"].slice(3), value: res.respuesta[dimension][18]["resultados"]["De Acuerdo"]}, {name: res.respuesta[dimension][19]["pregunta"].slice(3), value: res.respuesta[dimension][19]["resultados"]["De Acuerdo"]}, {name: res.respuesta[dimension][20]["pregunta"].slice(3), value: res.respuesta[dimension][20]["resultados"]["De Acuerdo"]}] });
        Object.assign(this, { muy_acuerdo: [{name: res.respuesta[dimension][17]["pregunta"].slice(3), value: res.respuesta[dimension][17]["resultados"]["Muy de Acuerdo"]}, {name: res.respuesta[dimension][18]["pregunta"].slice(3), value: res.respuesta[dimension][18]["resultados"]["Muy de Acuerdo"]}, {name: res.respuesta[dimension][19]["pregunta"].slice(3), value: res.respuesta[dimension][19]["resultados"]["Muy de Acuerdo"]}, {name: res.respuesta[dimension][20]["pregunta"].slice(3), value: res.respuesta[dimension][20]["resultados"]["Muy de Acuerdo"]}] });
      }
    );
  }
  ...
  modalPregunta(numero, descripcion){
    ...
    this._preguntasService.listarRespuestaPreguntas().subscribe(
      res => {
        Object.assign(this, { pregunta: [{name: "Muy en desacuerdo", value: res.respuesta[dimension][numero+16]["resultados"]["Muy en Desacuerdo"]}, {name: "En desacuerdo", value: res.respuesta[dimension][numero+16]["resultados"]["En Desacuerdo"]}, {name: "Neutral", value: res.respuesta[dimension][numero+16]["resultados"]["Neutral"]}, {name: "De acuerdo", value: res.respuesta[dimension][numero+16]["resultados"]["De Acuerdo"]}, {name: "Muy de acuerdo", value: res.respuesta[dimension][numero+16]["resultados"]["Muy de Acuerdo"]}] });
      }
    );
  }
  ...
  verGrafica(nivel){
    this.estado = false;
    var id_pregunta = (this.numero_pregunta+16);
