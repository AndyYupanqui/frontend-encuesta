...
@Component({
  selector: 'app-capacidad-respuesta',
  templateUrl: './capacidad-respuesta.component.html',
  styleUrls: ['./capacidad-respuesta.component.css'],
  providers: [PreguntasService]
})

export class CapacidadRespuestaComponent implements OnInit {

  displayedColumns: string[] = ['numero', 'descripcion', 'opciones'];
  dataSource: MatTableDataSource<PreguntaModel>;
  resultado_preguntas = [];
  resultado_detalle_pregunta = [];
    ...
    this._preguntasService.listarPreguntas().subscribe(
      res => {
        ...
        for(var i=0; i<res.preguntas.length; i++){
          if(res.preguntas[i]["id_dimension"] == 2){
  ...
  realizarGraficas(){
    var dimension = "Capacidad de Respuesta";
    this._preguntasService.listarRespuestaPreguntas().subscribe(
      res => {
        Object.assign(this, { muy_desacuerdo: [{name: res.respuesta[dimension][5]["pregunta"].slice(3), value: res.respuesta[dimension][5]["resultados"]["Muy en Desacuerdo"]}, {name: res.respuesta[dimension][6]["pregunta"].slice(3), value: res.respuesta[dimension][6]["resultados"]["Muy en Desacuerdo"]}, {name: res.respuesta[dimension][7]["pregunta"].slice(3), value: res.respuesta[dimension][7]["resultados"]["Muy en Desacuerdo"]}, {name: res.respuesta[dimension][8]["pregunta"].slice(3), value: res.respuesta[dimension][8]["resultados"]["Muy en Desacuerdo"]}] });
        Object.assign(this, { en_desacuerdo: [{name: res.respuesta[dimension][5]["pregunta"].slice(3), value: res.respuesta[dimension][5]["resultados"]["En Desacuerdo"]}, {name: res.respuesta[dimension][6]["pregunta"].slice(3), value: res.respuesta[dimension][6]["resultados"]["En Desacuerdo"]}, {name: res.respuesta[dimension][7]["pregunta"].slice(3), value: res.respuesta[dimension][7]["resultados"]["En Desacuerdo"]}, {name: res.respuesta[dimension][8]["pregunta"].slice(3), value: res.respuesta[dimension][8]["resultados"]["En Desacuerdo"]}] });
        Object.assign(this, { neutral: [{name: res.respuesta[dimension][5]["pregunta"].slice(3), value: res.respuesta[dimension][5]["resultados"]["Neutral"]}, {name: res.respuesta[dimension][6]["pregunta"].slice(3), value: res.respuesta[dimension][6]["resultados"]["Neutral"]}, {name: res.respuesta[dimension][7]["pregunta"].slice(3), value: res.respuesta[dimension][7]["resultados"]["Neutral"]}, {name: res.respuesta[dimension][8]["pregunta"].slice(3), value: res.respuesta[dimension][8]["resultados"]["Neutral"]}] });
        Object.assign(this, { de_acuerdo: [{name: res.respuesta[dimension][5]["pregunta"].slice(3), value: res.respuesta[dimension][5]["resultados"]["De Acuerdo"]}, {name: res.respuesta[dimension][6]["pregunta"].slice(3), value: res.respuesta[dimension][6]["resultados"]["De Acuerdo"]}, {name: res.respuesta[dimension][7]["pregunta"].slice(3), value: res.respuesta[dimension][7]["resultados"]["De Acuerdo"]}, {name: res.respuesta[dimension][8]["pregunta"].slice(3), value: res.respuesta[dimension][8]["resultados"]["De Acuerdo"]}] });
        Object.assign(this, { muy_acuerdo: [{name: res.respuesta[dimension][5]["pregunta"].slice(3), value: res.respuesta[dimension][5]["resultados"]["Muy de Acuerdo"]}, {name: res.respuesta[dimension][6]["pregunta"].slice(3), value: res.respuesta[dimension][6]["resultados"]["Muy de Acuerdo"]}, {name: res.respuesta[dimension][7]["pregunta"].slice(3), value: res.respuesta[dimension][7]["resultados"]["Muy de Acuerdo"]}, {name: res.respuesta[dimension][8]["pregunta"].slice(3), value: res.respuesta[dimension][8]["resultados"]["Muy de Acuerdo"]}] });
      }
    );
  }
  ...
  modalPregunta(numero, descripcion){
    ...
    this._preguntasService.listarRespuestaPreguntas().subscribe(
      res => {
        Object.assign(this, { pregunta: [{name: "Muy en desacuerdo", value: res.respuesta[dimension][numero+4]["resultados"]["Muy en Desacuerdo"]}, {name: "En desacuerdo", value: res.respuesta[dimension][numero+4]["resultados"]["En Desacuerdo"]}, {name: "Neutral", value: res.respuesta[dimension][numero+4]["resultados"]["Neutral"]}, {name: "De acuerdo", value: res.respuesta[dimension][numero+4]["resultados"]["De Acuerdo"]}, {name: "Muy de acuerdo", value: res.respuesta[dimension][numero+4]["resultados"]["Muy de Acuerdo"]}] });
      }
    );
  }
  ...
  verGrafica(nivel){
    this.estado = false;
    var id_pregunta = (this.numero_pregunta+4);
